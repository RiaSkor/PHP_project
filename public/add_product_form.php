...
<div class="wrapper">
    ...
    <main>
        <div class=content>
            <form action="action_form_add.php" method="post">
                <div class="form-container">
                    <h2>Добавить новый продукт</h2>
                    <p>Заполните форму для добавления товара в базу</p><br>

                    <fieldset>
                        <label for="name_products">Название продукта:</label>
                    ...
                    <fieldset>
                        <label for="image">Имя изображения (без расширения, например "краска1"):</label>
